...
DESCRIPTION="This libVA backend is designed to work with the Video for Linux Memory-To-Memory API that is used by a number of video codecs drivers, in particular SoCs found on SBCs."
...
# Portage.
EGIT_REPO_URI="https://github.com/mxsrc/libva-v4l2.git"
