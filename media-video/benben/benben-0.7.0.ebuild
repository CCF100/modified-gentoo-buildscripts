...
DESCRIPTION="Benben is a fast and efficient command line audio player and audio converter for Linux and other Unix-like systems with an oldschool-inspired interface."

# Homepage, not used by Portage directly but handy for developer reference
HOMEPAGE="https://chiselapp.com/user/MistressRemilia/repository/benben"

# Point to any required sources; these will be automatically downloaded by
# Portage.
#EFOSSIL_REPO_URI="${HOMEPAGE}"
SRC_URI="https://chiselapp.com/user/MistressRemilia/repository/benben/tarball/v${PV}/benben--v${PV}.tar.gz https://nanako.mooo.com/fossil/libremicsid/tarball/f52087551c/libremicsid--f52087551c.tar.gz"
...
RDEPEND=" \
	...
	>=media-libs/libxmp-4.6.0 \
	>=media-libs/libsidplayfp-2.11.0 \
	>=media-sound/wavpack-5.8.1 \
	>=media-libs/opus-1.5.2 \
	>=media-libs/libao-1.2.2-r3 \
	alsa? ( media-libs/alsa-lib ) \
	"
# media-libs/libremicsid
# Build-time dependencies that need to be binary compatible with the system
# being built (CHOST). These include libraries that we link against.
# The below is valid if the same run-time depends are required to compile.
DEPEND="${RDEPEND} dev-lisp/sbcl"
